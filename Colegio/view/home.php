...
<head>
    ...
    <!-- icons -->
    <script
            src="https://kit.fontawesome.com/6d0db64a1f.js"
    ...
    <style>
        ...
        .content-main {
            ...
            background: #f8f9fa; /* Chrome 10-25, Safari 5.1-6 */
    ...
    <link href="../assets/css/sidebar/sidebars.css" rel="stylesheet"/>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="validate-form" action="../controller/ControllerStudents.php" method="post">
